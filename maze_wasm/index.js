...
window.genSetMaze = async function genSetMaze() {
   ...
   let maze_data = carve_maze(mazegen_algo, mazegen_seed);
   document.getElementById('num-deadends').innerHTML = maze_data.num_deadends;
   let maze_lines_svg = maze_data.maze_svg();
